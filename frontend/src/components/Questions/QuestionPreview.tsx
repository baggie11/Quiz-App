                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {isCorrect && (
                        <div className="flex items-center gap-1 text-green-700 dark:text-emerald-300 text-sm font-medium">
  ...
  return (
    ...
    >
      <div className="min-h-screen px-4 text-center">
        ...
        <div className="inline-flex h-[90vh] flex-col w-full max-w-5xl my-8 text-left align-middle transition-all transform min-h-0">
