    ...
    <footer className="bg-gray-50 border-t border-gray-200 mt-16">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600">© 2025 Shravya. All rights reserved.</p>
...
before:bg-[radial-gradient(circle_at_top_left,rgba(99,102,241,0.12),transparent_60%)]
...
">
              ...
              <div className="flex items-center justify-between mb-4 px-4">
                {['welcome', 'listenCode', 'confirm', 'joining'].map((step, i) => (
                  <div key={step} className={`flex flex-col items-center ${currentStep === step ? 'text-[#2563eb]' : 'text-gray-400'}`}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep === step ? 'bg-gradient-to-br from-indigo-500 to-blue-600 text-white shadow-lg ring-4 ring-indigo-100' : 'bg-white border border-gray-200 text-gray-400'}`}>
                      {i + 1}
                    </div>
            ...
            {/* Status Indicator */}
            <div className="max-w-xl mx-auto mb-6">
              <div className="flex items-center justify-center space-x-3 p-4 rounded-xl bg-white/80 backdrop-blur-xl
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl font-semibold text-base transition-all ${
                  joinCode && currentStep !== 'joining' && !isLoadingAudio
                    ? 'bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-700shadow-[0_15px_40px_rgba(37,99,235,0.35)]hover:shadow-[0_20px_60px_rgba(37,99,235,0.45)]hover:scale-[1.01]transition-all duration-300'
