      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-2xl font-bold text-gray-900">Shravya</span>
          </div>
    ...
    <footer className="bg-gray-50 border-t border-gray-200 mt-16">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-gray-900">Shravya</span>
            </div>
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600">© 2024 Shravya. All rights reserved.</p>
      ...
      {(isLoading || isPlaying || audioError) && (
        <div className="fixed top-4 right-4 z-50 rounded-lg shadow-lg p-3 max-w-xs bg-white border border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={testTTS}
              className="h-9 px-3 text-sm bg-gray-100 hover:bg-gray-200 rounded-lg text-gray-600 flex items-center justify-center"
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="w-full mb-8">
                    <div className="space-y-3">
                      <div className="group flex items-center gap-3 rounded-xl border border-blue-200 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-blue-300 hover:shadow-md dark:border-slate-600 dark:bg-slate-900 dark:hover:border-blue-400/60">
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-100 text-[#2563eb] dark:bg-blue-500/20 dark:text-blue-200">
                          <ClipboardCheck size={17} />
                        </div>
                        <div className="text-left">
                          <div className="text-sm font-semibold text-gray-900 dark:text-slate-100">Quick Join</div>
                          <div className="text-xs text-gray-600 dark:text-slate-300">Enter code and start immediately</div>
                        </div>
                      </div>
                      <div className="group flex items-center gap-3 rounded-xl border border-blue-200 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-blue-300 hover:shadow-md dark:border-slate-600 dark:bg-slate-900 dark:hover:border-blue-400/60">
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-100 text-[#2563eb] dark:bg-blue-500/20 dark:text-blue-200">
                        ...
                        <div className="text-left">
                          <div className="text-sm font-semibold text-gray-900 dark:text-slate-100">Live Scoring</div>
                          <div className="text-xs text-gray-600 dark:text-slate-300">See your rank in real-time</div>
                        </div>
                      </div>
                      <div className="group flex items-center gap-3 rounded-xl border border-blue-200 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-blue-300 hover:shadow-md dark:border-slate-600 dark:bg-slate-900 dark:hover:border-blue-400/60">
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-100 text-[#2563eb] dark:bg-blue-500/20 dark:text-blue-200">
                        ...
                        <div className="text-left">
                          <div className="text-sm font-semibold text-gray-900 dark:text-slate-100">Easy Participation</div>
                          <div className="text-xs text-gray-600 dark:text-slate-300">Simple interface for all users</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className={`w-full h-12 px-6 rounded-xl font-semibold text-base transition-all flex items-center justify-center space-x-2 ${
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="w-full mb-8">
                    <div className="space-y-3">
                      <div className="group flex items-center gap-3 rounded-xl border border-emerald-200 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-emerald-300 hover:shadow-md dark:border-slate-600 dark:bg-slate-900 dark:hover:border-emerald-400/60">
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-200">
                          <Sparkles size={17} />
                        </div>
                        <div className="text-left">
                          <div className="text-sm font-semibold text-gray-900 dark:text-slate-100">Quiz Builder</div>
                          <div className="text-xs text-gray-600 dark:text-slate-300">Create custom quizzes easily</div>
                        </div>
                      </div>
                      <div className="group flex items-center gap-3 rounded-xl border border-emerald-200 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-emerald-300 hover:shadow-md dark:border-slate-600 dark:bg-slate-900 dark:hover:border-emerald-400/60">
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-200">
                        ...
                        <div className="text-left">
                          <div className="text-sm font-semibold text-gray-900 dark:text-slate-100">Analytics Dashboard</div>
                          <div className="text-xs text-gray-600 dark:text-slate-300">Track participant performance</div>
                        </div>
                      </div>
                      <div className="group flex items-center gap-3 rounded-xl border border-emerald-200 bg-white px-4 py-3 shadow-sm transition-all duration-200 hover:border-emerald-300 hover:shadow-md dark:border-slate-600 dark:bg-slate-900 dark:hover:border-emerald-400/60">
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-200">
                        ...
                        <div className="text-left">
                          <div className="text-sm font-semibold text-gray-900 dark:text-slate-100">Full Control</div>
                          <div className="text-xs text-gray-600 dark:text-slate-300">Manage settings and access</div>
                        </div>
                      </div>
                    </div>
                  </div>
