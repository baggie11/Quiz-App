import {
  ...
  deleteSessionDependencies,
  deleteSessionByIdAndTeacherId,
...
export async function removeSession(sessionId, teacherId) {
  ...
  await deleteSessionDependencies(sessionId);
  const deleted = await deleteSessionByIdAndTeacherId(sessionId, teacherId);
